...
class AssetManagementService
{
    ...
    public function buildAssetReport(Anlage $anlage, array $report, int $docType = 0, int $chartTypeToExport = 0, $exit = false): array
    {
        ...
        $operations_right = $chart->render('operations_right', ['style' => 'height: 400px; width:650px;']);
        $chart->tooltip = [];
        $chart->xAxis = [];
        $chart->yAxis = [];
        $chart->series = [];
        ...
        Config::addExtraScript('cool.js', 'https://dev.g4npvplus.net/echarts/theme/');
        $chart->setOption($option);
        $operations_monthly_left = $chart->render('operations_left', ['style' => 'height: 400px; width:800px;']);
        $chart->tooltip = [];
        $chart->xAxis = [];
        $chart->yAxis = [];
        $chart->series = [];
